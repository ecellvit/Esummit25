...
const Dashboard: React.FC = () => {
    ...
    const handleGoBack = () => {
        ...
        router.replace('/events/event1/round2/phase1');
    };
    ...
    return (
        <div className="aboslute w-full h-full min-h-screen bg-[#232323]">
            ...
            {/* Main Content */}
            <div
                className={`my-20 container w-[85vw] h-[75vh] py-20 px-auto px-2 text-center relative z-10 mx-auto transition-all duration-300 rounded-lg`}>
                ...
                <div className="flex flex-row gap-2 w-full justify-center h-[50vh] overflow-y-auto scrollbar-hide ">
                    ...
                    {/* Right Section */}
                    <div className="w-1/3 bg-[#f9c786] px-6 rounded-xl">
                        <h2
                            className="text-2xl font-bold my-4 text-green-800 text-center uppercase tracking-wider"
                            style={{ fontFamily: "GreaterTheory" }}
                        >Resources</h2>
                ...
                <div className="mt-5 flex justify-center gap-10">
                    <button
                        ...
                        className="px-8 py-3 text-green-800 transition-all duration-300 shadow-lg active:shadow active:translate-y-1 flex items-center bg-[#f9c786] rounded-lg hover:bg-[#f4be78] hover:shadow-md hover:scale-105  font-extrabold tracking-widest"
                    >
