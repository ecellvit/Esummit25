...
export default function Island1Page() {
                ...
                if (
                    ...
                    try {
                        ...
                        if (response.ok) {
                            ...
                            if (team.setup[2] === 0 || team.setup[2] === 1) {
    ...
    const getPortfolioData = async () => {
        try {
            const response = await fetch(`/api/event1/round2/getIslandPortfolio?islandNumber=${encodeURIComponent(2)}`, {
                method: "GET"
            });
