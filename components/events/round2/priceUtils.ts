...
export const calculatePrice = (
  ...
  // Clear localStorage and store adjusted prices
  localStorage.clear();
  localStorage.setItem("adjustedPrices", JSON.stringify(adjustedPrices));
  console.log("Prices stored in localStorage:", adjustedPrices);
