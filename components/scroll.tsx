...
const Animation: React.FC = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full h-[75vh] md:h-[110vh] mb-10 bg-white flex flex-col items-center justify-center text-black p-6 text-2xl md:text-4xl font-[GreaterTheory]"
      id="scroll"
    >
