    ...
    >
      ...
      <div className="relative flex w-full flex-1 -scale-150 items-center justify-center isolate z-0 ">
        ...
        <motion.div
          ...
          className="absolute inset-auto right-1/2 overflow-visible bg-gradient-conic 
                     from-red-600 via-transparent to-transparent text-white
                     [--conic-position:from_70deg_at_center_top]"
        >
          {/* Mask divs remain the same */}
        ...
        <motion.div
          /* Same enlargement for the right side */
          initial={{ opacity: 0.5, width: "15rem", height: "15rem" }}
          whileInView={{ opacity: 1, width: "80rem", height: "80rem" }}
          transition={{
            delay: 0.3,
          ...
          className="absolute inset-auto left-1/2 overflow-visible bg-gradient-conic 
                     from-transparent via-transparent to-red-600 text-white
        ...
        {/* Existing center/bottom effects remain unchanged */}
      ...
      {/* The content (E-SUMMIT '25) remains in place */}
